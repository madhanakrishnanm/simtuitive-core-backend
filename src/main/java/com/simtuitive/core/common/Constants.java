package com.simtuitive.core.common;

public class Constants {

	public final static String GENERIC_RUNTIME_ERROR_MESSAEGE = "GENERIC_RUNTIME_ERROR_MESSAEGE";

	public final static String LINK_CREATE_ADMIN_DETAIL = "Admin User Detail";
	public final static String LINK_CREATE_SME_DETAIL = "SME User Detail";
	...
	public final static String PATH_UPDATE_ADMIN = "/updateAdmin";
	public final static String PATH_UPDATE_SME = "/updateSME";
	...
	public final static String PASSWORD_UPDATE_FAILURE = "Password not updated.Same Password given";
	public final static String PASSWORD_UPDATED_SUCCESS = "Password updated successfully";

	public final static String STR_ACTIVEUSERS = "aciveUsers";
	public final static String STR_ACTIVEEVENTS = "activeEvents";
	public final static String STR_COMPLETEDEVENTS = "completedEvents";
	public final static String STR_SCHEDULEDEVENTS = "scheduledEvents";

	public final static String PATH_GET_DASHBOARD = "/dashboard";
	public final static String LINK_GET_DASHBOARD = "Dashboard Detail";

	public final static String STR_AUTH_TOKEN = "token";
	...
	public static final String BAD_ARGUMENT_CODE = "400";

	public static final String BAD_ARGUMENT_TITLE = "BAD REQUEST";
