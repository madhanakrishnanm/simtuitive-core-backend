...
public class EventResponsePayload {
	...
	// Bookings
	public EventResponsePayload(String bookingId, String productId, String productName, String eventName,
			String noOfParticipants, Date startDate, Date endDate, String notes, Date createdAt, String status,
			Date updatedAt, String modifiedBy, String createdBy, String type, String orgId, String orgName,
			String clientId, String clientName, Map<String, String> client, Map<String, String> organisation,
	...
	// Events
	public EventResponsePayload(String eventId, String orgId, String orgName, String clientId, String clientName,
			...
			String modifiedBy, String createdBy, String type, List<EventSessions> sessions, String passCode) {
		super();
		this.eventId = eventId;
		this.orgId = orgId;
		this.orgName = orgName;
	...
	public String toString() {
		return "EventResponsePayload [eventId=" + eventId + ", bookingId=" + bookingId + ", orgId=" + orgId
				+ ", orgName=" + orgName + ", clientId=" + clientId + ", clientName=" + clientName + ", productId="
				+ productId + ", productName=" + productName + ", eventName=" + eventName + ", noOfParticipants="
				+ noOfParticipants + ", tollPass=" + tollPass + ", startDate=" + startDate + ", endDate=" + endDate
				+ ", notes=" + notes + ", createdAt=" + createdAt + ", status=" + status + ", updatedAt=" + updatedAt
				+ ", modifiedBy=" + modifiedBy + ", createdBy=" + createdBy + ", type=" + type + ", sessions="
				+ sessions + ", passCode=" + passCode + "]";
	}
