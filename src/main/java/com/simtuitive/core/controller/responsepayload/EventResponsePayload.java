...
public class EventResponsePayload {
	...
	//Bookings
		...
		//Events
		public EventResponsePayload(String eventId, String orgId, String orgName, String clientId, String clientName, String productId,
				String productName, String eventName, String noOfParticipants, String tollPass, Date startDate,
				Date endDate, String notes, Date createdAt, String status, Date updatedAt, String modifiedBy,
				String createdBy, String type, List<EventSessions> sessions, String passCode) {
			super();
			this.eventId = eventId;
			this.orgId = orgId;
			this.orgName = orgName;
		...
		public String toString() {
			return "EventResponsePayload [eventId=" + eventId + ", bookingId=" + bookingId + ", orgId=" + orgId
					...
					+ ", notes=" + notes + ", createdAt=" + createdAt + ", status=" + status + ", updatedAt="
					+ updatedAt + ", modifiedBy=" + modifiedBy + ", createdBy=" + createdBy + ", type=" + type
					+ ", sessions=" + sessions + ", passCode=" + passCode + "]";
		}
