...
public class OrganisationResponsePayload implements Serializable {
	/**
	 * 
	 */
	...
	public String toString() {
		return "OrganisationResponsePayload [organizationName=" + organizationName + ", organizationId="
				+ organizationId + ", location=" + location + ", industry=" + industry + ", dealOwnerName="
				+ dealOwnerName + ", dealOwnerEmail=" + dealOwnerEmail + ", dealOwnerMobile=" + dealOwnerMobile
				+ ", createdAt=" + createdAt + ", status=" + status + ", creditLimit=" + creditLimit + ", updatedAt="
				+ updatedAt + ", modifiedBy=" + modifiedBy + "]";
	}
