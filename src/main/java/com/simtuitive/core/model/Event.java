...
public class Event implements Serializable{
	...
	//Events
	public Event(String orgId, String orgName, String clientId, String clientName, String productId,
	...
	public String toString() {
		return "Event [eventId=" + eventId + ", orgId=" + orgId + ", orgName=" + orgName + ", clientId=" + clientId
				...
				+ createdBy + ", type=" + type + ", sessions=" + sessions + "]";
	}
